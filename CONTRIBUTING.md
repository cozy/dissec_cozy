# How to contribute to DISSEC-COZY?
...
- What is the version of the DISSEC-COZY app?
...
```
$ git clone github.com/JulienMirval/dissec_cozy.git
$ cd dissec_cozy
$ git remote add fork git://github.com/yourusername/dissec_cozy.git
```
...
Go to https://github.com/yourusername/dissec_cozy and select your branch. Click the 'Pull Request' button and fill out the form.
...
The DISSEC-COZY is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/JulienMirval/dissec_cozy/issues/new
...
[localization]: https://github.com/JulienMirval/dissec_cozy/blob/master/README.md#localization
